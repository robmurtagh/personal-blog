...
- *Language* - Instead of Javascript you write [ReasonML](https://reasonml.org/)
- *Components* - Instead of manipulating Browser DOM elements, you manipulate [Revery Components](https://www.outrunlabs.com/revery/api/revery/) such as button and slider
- *Layout* - Instead of using Browser CSS, you use a [ReasonML CSS layout implementation](https://github.com/jordwalke/flex)
- *Framework* - Instead of manipulating your components with ReactJS, you manipulate them with [Brisk](https://github.com/briskml/brisk-reconciler), a ReasonML implementation which matches the React API
...
On the first build this will do quite a lot of work, but subsequently this should be *super* quick. You might even be able to speed this up by [pre-installing some packages](https://github.com/revery-ui/revery/wiki/Building-&-Installing) If all goes we'll you should now be looking at a simple quickstart application:

![Revery Quickstart Launch](https://dev-to-uploads.s3.amazonaws.com/i/8u3u1roz6f1c7w91ysqp.png)
...
![rtop](https://dev-to-uploads.s3.amazonaws.com/i/6j2cpec4jv1yyb627hoq.png)
...
![controlled component](https://dev-to-uploads.s3.amazonaws.com/i/4nvyvm9p1oh2eta6vdks.png)
